...
using UManagement.Authorization.Accounts;
...
namespace UManagement.Users
{
    public class UserAppService : AsyncCrudAppService<User, UserDto, long, PagedUserResultRequestDto, CreateUserDto, UserDto>, IUserAppService
    {
        ...
        [HttpPost]
        public async Task<string> PostFileImport(IFormFile file)
        {
            ...
            try
            {
                ...
                string pathFile = Path.Combine(test, "IMPORT_USER\\" + maker.Name + "\\");
